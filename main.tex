...
\begin{abstract}
By maximizing entropy through Landauer information erasure within the quantum of action, we show that continuum states collapse into discrete observables. Numerical analysis confirms that this geometry accurately reproduces key quantum phenomena. This work provides an algorithmic-geometric correspondence to quantum mechanics at the entropic limit of action.
\end{abstract}
