...
The orthodox application of the Heisenberg Uncertainty Principle implies that as a system's total action scales up, its minimal phase-space area---the single ``blob'' defined by $\Delta q \Delta p$---must expand. However, the foundational architects of quantum mechanics recognized immediately that this single-blob macroscopic scaling violates empirical reality. 

As Schr\"{o}dinger observed in 1926 \cite{Schrodinger1926, Schrodinger1928_English}, and as Einstein formally critiqued in 1953 \cite{Einstein1953, BornEinsteinLetters1971}, permitting a single uncertainty cell to grow proportionately with a system's energy strictly predicts that macroscopic objects should exist as delocalized, unobservable smears. While Schr\"{o}dinger ultimately patched this macroscopic paradox by introducing coherent states---relying on the infinite superposition of wavefunctions to force localization---we propose a strictly geometric solution. Here, macroscopic scaling is achieved through a pair of orthogonal, conjugate phase-space blobs, governed by polar duals that strictly conserve the fundamental action area of $\pi \hbar$.
