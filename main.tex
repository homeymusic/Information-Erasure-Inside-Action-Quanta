...
\begin{equation}
\label{eq:ResolvingPowerCoordinatePlain}
\substack{\text{Coordinate} \\ \text{Bit Budget}}
\sim 
\substack{\text{Coordinate} \\ \text{Resolving Power}} 
\sim
\substack{\text{Momentum} \\ \text{Boundary}}
\end{equation}

\begin{equation}
\label{eq:BitBudgetResolutionCoordinate}
K_q \sim \mathcal{R}_q \sim \Delta p
\end{equation}

\begin{equation}
\label{eq:ResolvingPowerMomentumPlain}
\substack{\text{Momentum} \\ \text{Bit Budget}}
\sim 
\substack{\text{Momentum} \\ \text{Resolving Power}} 
\sim
\substack{\text{Coordinate} \\ \text{Boundary}}
\end{equation}

\begin{equation}
\label{eq:BitBudgetResolutionMomentum}
K_p \sim \mathcal{R}_p \sim \Delta q
\end{equation}

$$
\mathcal{R}_q = \frac{1}{\delta q}
\quad
\mathcal{R}_p = \frac{1}{\delta p}
$$
