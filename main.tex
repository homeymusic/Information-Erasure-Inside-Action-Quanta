...
\begin{itemize}
    ...
    \item \textbf{The "P Blob" (Momentum Focus):} This state prioritizes the resolution of momentum information. To achieve a collapse to a discrete observable $\mathrm{P}$, the system utilizes the algorithmic "slack" of the conjugate position, satisfying:
    \begin{equation}
...
On the algorithmic side, the universe discards a string length $\Delta I = |s_?| - |\mathbf{s^*}|$. On the physical side, this is expressed as the fluctuation:
\begin{equation}
