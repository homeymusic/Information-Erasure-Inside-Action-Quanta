...
Total system entropy $ \mathrm{S} = \mathrm{H} + \mathrm{K}$ must be less than or equal to the normalized action $\frac{A}{A_0}$, where $A$ is the system action and $A_0$ is the quantum of action $A_0=\frac{pi}{4} q_0 p_0 = \frac{h}{2}$.
