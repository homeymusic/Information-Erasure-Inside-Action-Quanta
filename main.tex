...
\begin{figure}[htbp]
    ...
    \caption{Erasing surplus bits from $x_?$  Phase-space representation of the symplectic quantum of action $\mathcal{A}=h/2$. The shaded region represents the "quantum blob" with area constraint $x_0 p_0 = h/2$.}
